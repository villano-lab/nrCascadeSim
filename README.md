...
`?reproducible=fixedname` (you will either need to put the filename in quotes or escape the `?` character).
...
If you wish to verify the program, the md5sum of a file generated by the following command:
`bin/realizeCascades -n 100000 -o "output.root?reproducible=fixedname" -d 1 levelfiles/Si28_ngam_all_cascades_rfmt_sorted.txt`
should be:
`4fdf2ca6a36f218e906294082d51d800`
